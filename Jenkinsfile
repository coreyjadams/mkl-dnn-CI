pipeline {
    ...
    * escape it as "\$". */
    environment {
        ...
        MKL_DNN_RELEASE = 'master'
        BUILD_ROOT = '/projects/datascience/jenkins-test/mkl-dnn-build'
        RELEASE_ROOT = '/projects/datascience/jenkins-test/mkl-dnn-release'
